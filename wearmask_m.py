...
# IMAGE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'images')
DEFAULT_IMAGE_PATH = os.path.join(IMAGE_DIR, 'mask1.png')
...
def cli(pic_path = '/home/infor/mask/database/Real-World-Masked-Face-Dataset/wear_mask_to_face/data/0_0_aidai_0014.jpg',save_pic_path = ''):
...
class FaceMasker:
    ...
    def mask(self):
        ...
        if found_face:
            ...
            with open("log",'a',encoding = 'utf-8') as f:
                f.write('Found no face.'+self.save_path + '\n')
            #fo.close()
            print(self.save_path)
            #move file 
            shutil.move(self.save_path, '/home/infor/mask/database/Real-World-Masked-Face-Dataset/wear_mask_to_face/defaults')
    ...
    def _mask_face(self, face_landmark: dict):
        ...
        # add mask 
            offset_n = 10
            self._face_img.paste(mask_img, (box_x+offset_n, box_y+offset_n), mask_img)
...
if __name__ == '__main__':
    ...
    dataset_path = '/home/infor/InsightFace_Pytorch/data/faces_emore/imgs_'
    save_dataset_path = '/home/infor/InsightFace_Pytorch/data/faces_emore/imgs_'
